        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-12">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                onClick={toggleLang}
                className="p-2 rounded-full bg-gray-100 dark:bg-slate-800 text-gray-700 dark:text-gray-200 hover:bg-gray-200 dark:hover:bg-slate-700 transition-colors focus:outline-none ring-1 ring-gray-200 dark:ring-slate-700 w-10 h-10 flex items-center justify-center text-sm font-bold tracking-wide"
